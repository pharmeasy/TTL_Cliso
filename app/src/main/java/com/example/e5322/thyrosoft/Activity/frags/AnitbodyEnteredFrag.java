 ...
 * Use the {@link AnitbodyEnteredFrag#newInstance} factory method to
 * create an instance of this fragment.
 */
public class AnitbodyEnteredFrag extends Fragment {
    ...
    public AnitbodyEnteredFrag() {
        // Required empty public constructor
    }


    public static AnitbodyEnteredFrag newInstance(String param1, String param2) {
        AnitbodyEnteredFrag fragment = new AnitbodyEnteredFrag();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        root = inflater.inflate(R.layout.fragment_anitbody_entered, container, false);
        initui(root);
        initlistner();
        return root;
    }
