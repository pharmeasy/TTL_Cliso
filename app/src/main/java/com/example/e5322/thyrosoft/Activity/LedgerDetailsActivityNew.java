...
public class LedgerDetailsActivityNew extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ledger_details_new);
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (Integer.parseInt(year.getSelectedItem().toString()) == thisYear) {
                    for (int i = 0; i <= thismonth; i++) {
                        ...
                        monthadap = new ArrayAdapter(LedgerDetailsActivityNew.this, R.layout.spinner_property_main, monthlist);
                    }
                } else {
                    monthadap = new ArrayAdapter(LedgerDetailsActivityNew.this, R.layout.spinner_property_main, monthNames);
                ...
                if (!GlobalClass.isNetworkAvailable(LedgerDetailsActivityNew.this)) {
    ...
    private void GetData() {
        ...
        PostQue = GlobalClass.setVolleyReq(LedgerDetailsActivityNew.this);
        ...
        RequestQueue queue = GlobalClass.setVolleyReq(LedgerDetailsActivityNew.this);
