...
public class BMC_Scan_BarcodeActivity extends AppCompatActivity implements RecyclerInterface {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        POstQue = GlobalClass.setVolleyReq(BMC_Scan_BarcodeActivity.this);
            ...
            if (gpsTracker.canGetLocation()) {
                ...
                if (addresses != null) {
                    if (addresses.size() != 0) {
                        ...
                        Log.v("",addresses.get(0).getAdminArea());
                        Log.v("",addresses.get(0).getCountryName());
                        Log.v("",addresses.get(0).getLocality());
                    }
                } else {
                    getStateName = "";
                    getCountryName = "";
                            ...
                            public void onResponse(JSONObject response) {
                                try {
                                    ...
                                    if (status.equalsIgnoreCase("SUCCESS")) {
                                        ...
                                        editor.commit();
                                        barProgressDialog.show();
                                        sendGPSDetails = GlobalClass.setVolleyReq(BMC_Scan_BarcodeActivity.this);
