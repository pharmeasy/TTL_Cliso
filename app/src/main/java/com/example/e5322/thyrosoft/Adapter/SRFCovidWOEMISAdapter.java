...
public class SRFCovidWOEMISAdapter extends RecyclerView.Adapter<SRFCovidWOEMISAdapter.Viewholder> {
    Context context;
    List<Covidmis_response.OutputBean> covidMISmodelList;
    Activity activity;
    List<String> doclist = new ArrayList<>();

    public SRFCovidWOEMISAdapter(Context context, List<Covidmis_response.OutputBean> covidMISmodelList, Activity activity) {
    ...
    @NonNull
    @Override
    public SRFCovidWOEMISAdapter.Viewholder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View itemView = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.adapter_covidmis, viewGroup, false);
        return new SRFCovidWOEMISAdapter.Viewholder(itemView);
    }

    @Override
    public void onBindViewHolder(@NonNull SRFCovidWOEMISAdapter.Viewholder viewholder, int i) {
        ...
        viewholder.ll_main.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(context, SRFCovidWOEEditActivity.class);
                Bundle bundle = new Bundle();
                bundle.putSerializable("covid_model", covidMISmodel);
