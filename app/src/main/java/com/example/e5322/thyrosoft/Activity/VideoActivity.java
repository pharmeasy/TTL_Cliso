        ...
        responseCall.enqueue(new Callback<VideosResponseModel>() {
            ...
            public void onResponse(Call<VideosResponseModel> call, Response<VideosResponseModel> response) {
                ...
                if (response.isSuccessful() && response.body() != null) {
                    ...
                    if (!GlobalClass.isNull(responseModel.getResId()) && responseModel.getResId().equalsIgnoreCase("RSS0000") && responseModel.getOutput() != null && responseModel.getOutput().size() > 0) {
                        tv_noDatafound.setVisibility(View.GONE);
