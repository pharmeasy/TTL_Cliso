...
public class Splash_screenActivity extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        SharedPreferences p = PreferenceManager.getDefaultSharedPreferences(Splash_screenActivity.this);
        ...
        if (!isNetworkAvailable()) {
            ...
            if (user != null && passwrd != null) {
                Intent prefe = new Intent(Splash_screenActivity.this, ManagingTabsActivity.class);
                startActivity(prefe);
                finish();
            } else {
...
// clearing app data
    ...
    private void getversion() {
        RequestQueue requestQueuepoptestILS = Volley.newRequestQueue(Splash_screenActivity.this);
                            ...
                            public void onAnimationEnd(Animation animation) {
                                ...
                                if (intPkgversion >= intApiVersion) {//intPreversion<intNewVersion
                                    ...
                                    if (user != null && passwrd != null) {
                                        ...
                                        Intent i = new Intent(Splash_screenActivity.this, Login.class);
                                        startActivity(i);
                                        finish();
                                    }
                                } else {
