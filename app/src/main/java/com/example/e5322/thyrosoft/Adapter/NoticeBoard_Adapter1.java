...
public class NoticeBoard_Adapter1 extends RecyclerView.Adapter<NoticeBoard_Adapter1.ViewHolder>  {
    ...
    public NoticeBoard_Adapter1(Context context, ArrayList<NoticeBoard_Model> array_notice, String msgCode1) {
        mContext = context;
    ...
    @NonNull
    @Override
    public NoticeBoard_Adapter1.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        LayoutInflater inflater = LayoutInflater.from(parent.getContext());
        View v = inflater.inflate(R.layout.notice_board_singleview, parent, false);
        // set the view's size, margins, paddings and layout parameters
        NoticeBoard_Adapter1.ViewHolder vh = new NoticeBoard_Adapter1.ViewHolder(v);
        return vh;
    }
