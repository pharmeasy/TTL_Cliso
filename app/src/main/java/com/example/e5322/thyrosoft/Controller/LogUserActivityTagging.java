...
public class LogUserActivityTagging {
    ...
    public LogUserActivityTagging(Activity activity, String screen) {
        try {
            SharedPreferences sharedPreferences = activity.getSharedPreferences("Userdetails", MODE_PRIVATE);
            ...
            if (!TextUtils.isEmpty(sharedPreferencesUserActivity.getString(Constants.SHR_USERNAME, ""))) {
                editorUserActivity.putString(Constants.SHR_USERNAME, sharedPreferencesUserActivity.getString(Constants.SHR_USERNAME, ""));
            } else {
