...
public class ExpandableListAdapterRateCalculator extends BaseExpandableListAdapter {
    ...
    private String TAG=ExpandableListAdapterRateCalculator.class.getSimpleName().toString();

    public ExpandableListAdapterRateCalculator(Activity activity, ArrayList<Product_Rate_CalculatorModel> testRateMasterModels1, ArrayList<Base_Model_Rate_Calculator> selectedTests, InterfaceRateCAlculator mcallback) {
...
//            Logger.verbose("FilteredListSizeAfterFilerQueryEmpty: " + String.valueOf(filteredList.size()));
            ...
            for (Product_Rate_CalculatorModel testTypeModel : testRateMasterModels) {
                ...
                ArrayList<Base_Model_Rate_Calculator> newList = new ArrayList<Base_Model_Rate_Calculator>();
