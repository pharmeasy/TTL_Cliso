...
public class MyProfile extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if (prof != null) {
            ...
            GlobalClass.DisplayImgWithPlaceholderFromURL(getActivity(), tsp_img, profimg, R.drawable.userprofile);
                ...
                new com.android.volley.Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject response) {
                        try {
                            ...
                            GlobalClass.DisplayImgWithPlaceholderFromURL(getActivity(), prof, profimg, R.drawable.userprofile);
