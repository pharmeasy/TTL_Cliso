...
public class CampIntimation_Adapter extends RecyclerView.Adapter<CampIntimation_Adapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ViewHolder viewHolder, final int i) {
        ...
        GlobalClass.SetText(viewHolder.camp_sr, String.valueOf(position));
        GlobalClass.SetText(viewHolder.camp_date, campIntimatgionListModels.get(i).getCamp_date());
        GlobalClass.SetText(viewHolder.camp_profile, campIntimatgionListModels.get(i).getCamp_profile());
