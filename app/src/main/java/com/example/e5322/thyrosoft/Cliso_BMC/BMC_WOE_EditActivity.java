...
public class BMC_WOE_EditActivity extends AppCompatActivity {
    ...
    private String TAG = BMC_WOE_EditActivity.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bmc_woe_edit);
        ...
        ArrayAdapter PatientsagespinnerAdapter = ArrayAdapter.createFromResource(BMC_WOE_EditActivity.this, R.array.Patientsagespinner, R.layout.spinner_item);
        ...
        prefs = BMC_WOE_EditActivity.this.getSharedPreferences("Userdetails", MODE_PRIVATE);
        ...
        age_edt.addTextChangedListener(new TextWatcher() {
            ...
            public void afterTextChanged(Editable s) {
                ...
                if (enteredString.startsWith(".") || enteredString.startsWith("0")) {
                    Toast.makeText(BMC_WOE_EditActivity.this,
                            ToastFile.crt_age,
                ...
                if (age_edt.getText().toString().equals("")) {
                    ...
                    if (agesinteger > 12) {
                        ArrayAdapter Patientsagespinner = ArrayAdapter.createFromResource(BMC_WOE_EditActivity.this, R.array.Patientspinyrday, R.layout.spinner_item);
                        spinyr.setAdapter(Patientsagespinner);
                    }
                    if (agesinteger > 29) {
                        ArrayAdapter Patientsagesyr = ArrayAdapter.createFromResource(BMC_WOE_EditActivity.this, R.array.Patientspinyr, R.layout.spinner_item);
        ...
        if (GlobalClass.summary_models != null) {
            brand_name.setText(GlobalClass.summary_models.get(0).getWoeditlist().getWoe().getBRAND().trim());
            selectType_txt.setText(GlobalClass.summary_models.get(0).getWoeditlist().getWoe().getTYPE().trim());
            name_edt.setText(GlobalClass.summary_models.get(0).getWoeditlist().getWoe().getPATIENT_NAME().trim());
            name_edt.requestFocus();
            name_edt.setSelection(name_edt.getText().toString().length());
            sub_source_code.setText(GlobalClass.summary_models.get(0).getWoeditlist().getWoe().getSUB_SOURCE_CODE().trim());
        ...
        name_edt.addTextChangedListener(new TextWatcher() {
            ...
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                ...
                if (enteredString.startsWith(" ") || enteredString.startsWith("!") || enteredString.startsWith("@") ||
                    ...
                    Toast.makeText(BMC_WOE_EditActivity.this, ToastFile.crt_name, Toast.LENGTH_SHORT).show();
                    if (enteredString.length() > 0) {
        ...
        next_btn_patient.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (getName.equals("") || getName.equals(null)) {
                    ...
                    Toast.makeText(BMC_WOE_EditActivity.this, ToastFile.ent_age, Toast.LENGTH_SHORT).show();
                } else if (getAgeType.equals("") || getAgeType.equals(null)) {
                    Toast.makeText(BMC_WOE_EditActivity.this, ToastFile.ent_age_type, Toast.LENGTH_SHORT).show();
                } else if (saveGenderId.equals("") || saveGenderId.equals(null)) {
                    Toast.makeText(BMC_WOE_EditActivity.this, ToastFile.ent_gender, Toast.LENGTH_SHORT).show();
                } else {
    ...
    private void doWOE_edit() {
        barProgressDialog = new ProgressDialog(BMC_WOE_EditActivity.this);
        ...
        POstQue = GlobalClass.setVolleyReq(BMC_WOE_EditActivity.this);
            ...
            public void onResponse(JSONObject response) {
                try {
                    ...
                    if (status.equalsIgnoreCase("SUCCESS")) {
                        ...
                        TastyToast.makeText(BMC_WOE_EditActivity.this, message, TastyToast.LENGTH_SHORT, TastyToast.ERROR);

                        final AlertDialog alertDialog = new AlertDialog.Builder(BMC_WOE_EditActivity.this).create();
        ...
        jsonObjectRequest1.setRetryPolicy(new DefaultRetryPolicy(150000, 3, DefaultRetryPolicy.DEFAULT_BACKOFF_MULT));
