...
public class Windup_adapter extends RecyclerView.Adapter<Windup_adapter.ViewHolder> {
    ...
    public void onBindViewHolder(final ViewHolder holder, final int position) {
        ...
        if (!GlobalClass.isNull(patients.get(position).getConfirm_status()) && patients.get(position).getConfirm_status().equals("NO")) {
        ...
        GlobalClass.SetText(holder.puttestName,patients.get(position).getTests());
        GlobalClass.SetText(holder.show_amt_txt,patients.get(position).getB2B());
