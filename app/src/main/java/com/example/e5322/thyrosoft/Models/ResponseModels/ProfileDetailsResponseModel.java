...
public class ProfileDetailsResponseModel {
    ...
    public void setTPCPercent(int TPCPercent) {
        this.TPCPercent = TPCPercent;
    }
    ...
    public String getPriOTP() {
        return PriOTP;
    }

    public void setPriOTP(String priOTP) {
        PriOTP = priOTP;
    }
    ...
    public void setUnbilledmaterial(String unbilledmaterial) {
        Unbilledmaterial = unbilledmaterial;
    }
